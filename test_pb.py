...
def test_oneof_decode_last_wins_from_concatenated_wire():
    ...
    # Act
    #
    dec = pb_decode(wire, ONEOF_SCHEMA)
...
# pb.pb_encode/pb_decode accept either a list of tuples (acyclic)
...
def test_decode_official(case):
    ...
    dec = pb_decode(case["blob"], case["schema"])
...
def test_encode_official(case):
    ...
    enc = pb_encode(case["values"], case["schema"])
...
def test_encode_mixed_keys_matches_official():
    ...
    # Act
    #
    enc = pb_encode(values_mixed, schema)
...
def test_maps_as_entries_decode_official_variants():
    ...
    #
    for blob in blobs:
        dec = pb_decode(blob, MAPS_SCHEMA)
...
def test_maps_as_entries_encode_roundtrip_stable_values():
    ...
    # Act
    #
    enc = pb_encode(values, MAPS_SCHEMA)
    dec = pb_decode(enc, MAPS_SCHEMA)
...
def test_unknown_len_delim_preserved_when_changing_known():
    ...
    # Act
    #
    dec = pb_decode(UNKLD_ORIG, UNKLD_SCHEMA_REDUCED)
    dec["a"] = 8  # modify only known field
    # Re-encode with full schema, keeping unknown (tag 100) from decode
    values = {"a": dec["a"], 100: dec[100]}
    enc = pb_encode(values, UNKLD_SCHEMA_FULL)
...
def test_unknown_fixed32_preserved_when_changing_known():
    ...
    # Act
    #
    dec = pb_decode(UNK32_ORIG, UNK32_SCHEMA_REDUCED)
    dec["a"] = 8
    values = {"a": dec["a"], 100: dec[100]}
    enc = pb_encode(values, UNK32_SCHEMA_FULL)
...
def test_unknown_fixed64_preserved_when_changing_known():
    ...
    # Act
    #
    dec = pb_decode(UNK64_ORIG, UNK64_SCHEMA_REDUCED)
    dec["a"] = 8
    values = {"a": dec["a"], 100: dec[100]}
    enc = pb_encode(values, UNK64_SCHEMA_FULL)
...
def test_repeated_unknown_varint_preserved_order_when_roundtripped():
    ...
    # Act
    #
    dec = pb_decode(UNKREP_VARINT_ORIG, UNKREP_SCHEMA_REDUCED)
    ...
    enc = pb_encode(values, UNKREP_SCHEMA_FULL_VARINT)
...
def test_repeated_unknown_bytes_preserved_order_when_roundtripped():
    ...
    # Act
    #
    dec = pb_decode(UNKREP_BYTES_ORIG, UNKREP_SCHEMA_REDUCED)
    values = {"a": dec["a"], 101: dec[101]}
    enc = pb_encode(values, UNKREP_SCHEMA_FULL_BYTES)
...
def test_nested_unknowns_preserved_when_changing_known():
    ...
    # Act
    #
    dec = pb_decode(NESTED_UNK_ORIG, NESTED_UNK_SCHEMA_REDUCED)
    dec["inner"]["x"] = 8
    values = {"inner": {"x": dec["inner"]["x"], 100: dec["inner"][100]}}
    enc = pb_encode(values, NESTED_UNK_SCHEMA_FULL)
...
def test_decode_without_schema_numeric_and_fixed_types():
    ...
    # Act
    #
    dec = pb_decode(wire, schema=None)
